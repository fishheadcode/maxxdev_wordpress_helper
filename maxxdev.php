 ...
 */
function maxxdev_helper_register_posttype($post_type_name, $name, $singular_name, $text_new, $text_edit, $text_watch, $text_search, $text_search_not_found, $text_no_deleted_elements) {
// Labels
    $labels = array(
 ...
 * @param array $terms
 */
function maxxdev_helper_register_taxonomy($posttype, $singular, $plural, $terms = array()) {
    $labels = array(
 ...
 * @param string $folder
 */
function maxxdev_helper_add_css($filename, $style_name = "my_style", $folder = null) {
 ...
 * @param string $folder
 */
function maxxdev_helper_add_js($filename, $script_name = "my_script", $folder = null) {
    if ($folder === null || strlen($folder) === 0) {
...
// @TODO
function maxxdev_helper_add_admin_menu($page_title, $menu_title, $capability, $slug) {
